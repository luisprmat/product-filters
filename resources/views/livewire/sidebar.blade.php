<div class="col-lg-3 mb-4">
    ...
    <x-filter-group title="Categorías" options="categories" selected="selected.categories" />

    <x-filter-group title="Fabricantes" options="manufacturers" selected="selected.manufacturers" />
</div>
